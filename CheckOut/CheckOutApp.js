...
printFinalReceipt(cashierName, customerName, items, quantityOfItems, prices, numberOfItems, subTotal, discount, vat, totalBill, amountPaid, balance);
...
function printFinalReceipt(cashierName, customerName, items, quantityOfItems, prices, numberOfItems, subTotal, discount, vat, totalBill, amountPaid, balance){
    printHeader(cashierName, customerName);
    printItems(items, quantityOfItems, prices, numberOfItems);
    printSummary(subTotal, discount, vat, totalBill);
